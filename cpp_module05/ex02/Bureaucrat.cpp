...
void	Bureaucrat::executeForm(Form const & f)
{
	...
	else if (f.getIS() == true)
		std::cout << "Bureaucrat " + _name + " couldn't execute form " + f.getName() + "cause his grade is too low" << std::endl;
	else
		std::cout << "Bureaucrat " + _name + " couldn't execute form " + f.getName() + "cause the form is not been signed yet" << std::endl;
}
